...
const AdminApplications: React.FC = () => {
    ...
    const handleDeleteAll = () => {
        if (window.confirm('Are you sure you want to delete ALL applications? This action cannot be undone.')) {
            storageService.deleteAllApplications();
            setApplications([]);
        }
    };
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="flex items-center px-4 py-2 bg-white border border-red-300 text-red-600 rounded-lg shadow-sm text-sm font-medium hover:bg-red-50"
                    >
